...
const defaultTestimonials = [
  {
    text: "This platform cut our administrative workload by 50% in just a month. Our staff now focuses more on students than paperwork.",
    imageSrc: "https://i.pravatar.cc/150?img=11",
    name: "Jane Namatovu",
    username: "@greenfieldacademy",
    role: "Principal, Greenfield Academy",
  },
  {
    text: "Parents love the instant updates—it has completely transformed communication in our school.",
    imageSrc: "https://i.pravatar.cc/150?img=32",
    name: "David Kamya",
    username: "@brightmindshigh",
    role: "Director, Bright Minds High School",
  },
  {
    text: "Managing fees, attendance, and reports has never been this easy. We are saving hours every week.",
    imageSrc: "https://i.pravatar.cc/150?img=22",
    name: "Sarah Mirembe",
    username: "@hopevalleyprimary",
    role: "Teacher, Hope Valley Primary",
  },
  {
    text: "Our entire team adopted the system in just a few days—it’s that intuitive and simple to use.",
    imageSrc: "https://i.pravatar.cc/150?img=41",
    name: "Michael Odongo",
    username: "@starlightacademy",
    role: "Administrator, Starlight Academy",
  },
  {
    text: "From attendance to report cards, everything is seamless. It has boosted our school’s efficiency significantly.",
    imageSrc: "https://i.pravatar.cc/150?img=14",
    name: "Rebecca Atuhaire",
    username: "@sunshinejunior",
    role: "Head Teacher, Sunshine Junior",
  },
  {
    text: "The analytics dashboard gives us insights we never had before—helping us improve student performance.",
    imageSrc: "https://i.pravatar.cc/150?img=45",
    name: "Henry Bwambale",
    username: "@victoryhigh",
    role: "Deputy Principal, Victory High School",
  },
];
...
export default function TestimonialsCarousel({
  ...
  subtitle = 'From intuitive design to powerful features, our platform has become a compelling part and a darling to lots of school owners out there',
  autoplaySpeed = 3000,
  className,
}: TestimonialProps) {
